...
VERSION=3.1.0
[ -e $JAVASE ] || wget http://repo1.maven.org/maven2/com/google/zxing/javase/$V/javase-$V.jar
[ -e $CORE ] || wget http://repo1.maven.org/maven2/com/google/zxing/core/$V/core-$V.jar
rename -v 'tr/ ()/___/' *
